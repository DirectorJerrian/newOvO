...
VALUES (1,5,'测试二号',2,'儒家酒店','酒店旁边是综合商业区,有水游城、水平方、茂业天地、招商花园里等大型商业综合体，吃喝玩乐都能找到好去处。夫子庙景区就在酒店对面，3号线地铁站在酒店旁50米，交通便捷，不管是从南京站还是南京南站，只需20分钟不到即可到达酒店。南京站、南京南站、鸡鸣寺、总统府、玄武湖地铁都可直达。','2021-12-30',1),
       (2,5,'测试二号',2,'儒家酒店','酒店的地理位置很好 离地铁站和夫子庙很近 楼下也有很多便利店 小吃店和汤包馆 半夜馋了想吃零食或者下楼吃早饭都很方便 前台人很好很细心 很关照我们 在我们入住前发了一系列的指引和攻略 就算我们的行程一变再变 前台都是很耐心的在处理的 时刻都可以与我们保持联系 走进房间的时候真的有被惊喜到 很干净很温暖的色调 床很软很大 被子的材质很舒服 晚上开着空调盖着睡觉看电影真的很舒服 吊椅和墙边的小茶几都很出片 酒店真的什么生活细节都想到了 日常用品都备的很齐 南京真的是一个很适合生活的城市 文化底蕴深厚耐寻 人与人之间的社交距离也保持的很好 既然这次旅程只有短短的三天两夜 那么下次见啦 南京','2021-12-31',2),
